...
import pe.edu.upeu.PrimerParcialLee.mappers.ClienteMapper;
import pe.edu.upeu.PrimerParcialLee.repository.ClienteRepository;
import pe.edu.upeu.PrimerParcialLee.service.service.ClienteService;
...
public class ClienteServiceImpl implements ClienteService {
    ...
    public ClienteDTO update(Long aLong, ClienteDTO clienteDTO) throws ServiceException {
        try {
            ...
            cliente1.setTelefono(clienteDTO.getTelefone());
