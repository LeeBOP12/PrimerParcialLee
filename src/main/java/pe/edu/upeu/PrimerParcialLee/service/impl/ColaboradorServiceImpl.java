...
import pe.edu.upeu.PrimerParcialLee.mappers.ColaboradorMapper;
import pe.edu.upeu.PrimerParcialLee.repository.ColaboradorRepository;
import pe.edu.upeu.PrimerParcialLee.service.service.ColaboradorService;
...
public class ColaboradorServiceImpl implements ColaboradorService {
    ...
    public ColaboradorDTO update(Long aLong, ColaboradorDTO colaboradorDTO) throws ServiceException {
        try {
            ...
            colaborador1.setNumcuenta(colaboradorDTO.getNumcuenta());
