...
import pe.edu.upeu.PrimerParcialLee.mappers.ParticipaMapper;
import pe.edu.upeu.PrimerParcialLee.repository.ColaboradorRepository;
import pe.edu.upeu.PrimerParcialLee.repository.ParticipaRepository;
import pe.edu.upeu.PrimerParcialLee.repository.ProyectoRepository;
import pe.edu.upeu.PrimerParcialLee.service.service.ParticipaService;
...
public class ParticipaServiceImpl  implements ParticipaService{
    ...
    public ParticipaDTO create(ParticipaDTO participaDTO) throws ServiceException {
        ...
        Proyecto proyecto = proyectoRepository.findById(participaDTO.getIdproyecto())
                .orElseThrow(() -> new ResourceNotFoundException(
                        "Proyecto no encontrado con ID: " + participaDTO.getIdproyecto()));

        Colaborador colaborador = colaboradorRepository.findById(participaDTO.getIdcolaborador())
                .orElseThrow(() -> new ResourceNotFoundException(
                        "Colaborador no encontrado con ID: " + participaDTO.getIdcolaborador()));
    ...
    public ParticipaDTO update(Long aLong, ParticipaDTO participaDTO) throws ServiceException {
        ...
        Proyecto proyecto = proyectoRepository.findById(participaDTO.getIdproyecto())
                .orElseThrow(() -> new ResourceNotFoundException("Proyecto no encontrado con ID: " + participaDTO.getIdproyecto()));

        Colaborador colaborador = colaboradorRepository.findById(participaDTO.getIdcolaborador())
                .orElseThrow(() -> new ResourceNotFoundException("Colaborador no encontrado con ID: " + participaDTO.getIdcolaborador()));
